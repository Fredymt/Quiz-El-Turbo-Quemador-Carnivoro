...
export const AgeQuestion: React.FC<AgeQuestionProps> = ({ onSelect }) => {
  const ageOptions: { label: AgeRange; imageSrc: string }[] = [
  ...
  return (
    <div className="w-full max-w-2xl flex flex-col items-center animate-fade-in">
      ...
      {/* 3. Opciones con Imágenes - Distribución Flexible */}
